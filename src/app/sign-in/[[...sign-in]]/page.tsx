        ...
        <div style={{ position: 'relative', zIndex: 10 }}>
          ...
          <div style={{ marginTop: '3rem' }}>
            <h1 style={{ 
              ...
              <span style={{ color: '#e67e22' }}>You Don’t Exist.</span>
            </h1>
            <p style={{ fontSize: '1.25rem', opacity: 0.8, maxWidth: '500px', lineHeight: 1.4, fontFamily: 'var(--font-pjs)' }}>
              Secure access to your growth dashboard. <br />Real-world signal, tracked in real-time.
            </p>
          </div>
        </div>
        ...
        <div style={{ width: '100%', maxWidth: '440px' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
            ...
            <p style={{ 
              ...
              Access Your Local Dominance Engine
            </p>
          </div>
          ...
          <div style={{ textAlign: 'center', marginTop: '2.5rem' }}>
            <p style={{ fontFamily: 'var(--font-pjs)', color: 'rgba(255,255,255,0.3)', fontSize: '0.75rem' }}>
              ...
              <Link href="/sign-up" style={{ color: '#e67e22', fontWeight: 800, textDecoration: 'none', marginLeft: '0.5rem', letterSpacing: '0.05em' }}>
                SIGN UP
              </Link>
            </p>
          </div>
